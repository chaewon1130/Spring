        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover table-condensed">
              ...
              <tr>
                  ...
                  <td class="text-left   col-sm-2 col-md-2 col-lg-2">tubus1130</td>
                  <td class="text-left   col-sm-2 col-md-2 col-lg-2">김동호</td>
                  <td class="text-center col-sm-2 col-md-2 col-lg-2">BASIC</td>
                  <td class="text-left   col-sm-3 col-md-3 col-lg-3">tubus1130@gmail.com</td>
